...
- [x] Push Linux runtime/test head `8713bdc23b81263e1bdbc65e8d010ce57673877a` and final
  Flatpak/release-pin head `ec50565461b8a94311d297e054f8e6abd95fb130` (documentation-only
  descendant of runtime/package head `749ff81766d5963827110411d77bb1714eae91cc`).
- [x] Pass local formatting, GUI checks, localization/metadata/syntax checks, focused worker test,
  ...
  `30115826450`/`30115826498`/`30115826518` passed.
...
- [x] Push Linux functional commit `1547485795e75c8b1a0fcffb16ef1b72f0374496`, workflow l10n-pin
  correction `7ce5c60`, localization-test completion `e15f19b`, and consolidated status/Flatpak pin
  commit `e12ecf3`; update central component
  pins while keeping release `unreleased`.
- [x] Complete hosted push/PR checks, re-audit PR #1 and Issue #1, and record consolidated final
  evidence comments PR `5068392803` and Issue `5068394268`; checks passed under runs
  `30082859631`/`30082859638`/`30082859637` and `30082862089`/`30082862013`/`30082862004`.
...
- [x] Refresh Linux PR #1 to head `5904d2be68dee4ee8e02e137ba3c9ae9cf6568a4`, Core
  `01e228ca251252de331b285e5381cbb4fe0c30da`, and the six passing push/PR gate runs
  `30067853996`/`30067853960`/`30067853957` and `30067852102`/`30067852064`/`30067852097`.
