...
Linux-first document checkpoint: Core `31e7d3d06abbbf32199432bdedfcaf9a46dbed38` adds schema-8
validated non-secret document options on top of paused-job persistence. Linux
`d5e9bb13e75e172e8698d5227e4ac27a7e70dd35` adds restart reuse after exact provider/model matching;
Native `29644639413` (job `88080730976`) and Foundation `29644639392` (job `88080730938`) passed;
Flatpak `29644639396` (job `88080730937`) passed. Core CI `29644499145` and Native SDK `29644499158` passed.
