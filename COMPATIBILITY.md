...
| Localization | `0.1.0` | Message schema `1.0.0`; resource contract `1`; 107 canonical messages including Linux-only status, partial-output, text-import, provider-profile, source-target, onboarding-stage, active-provider, notification, and draft-note guidance | CI-verified development bundle, unreleased |
