...
| Localization | `0.1.0` | Message schema `1.0.0`; resource contract `1`; 267 canonical messages including Linux-only status, partial-output, text-import, glossary CSV import/export, PDF fidelity and subtitle readability warnings, Incognito privacy controls, history and translation-memory controls/status, translation-export, provider-profile, source-target, onboarding-stage, active-provider, notification, draft-note, locale selector language names, fixed provider/file/worker errors, reducer-state/category guidance, fixed worker/file/storage/provider-error guidance, construction-stage provider/default-control and request-level glossary copy, and Core/loopback startup plus profile-storage error copy; paired PO/MO Linux resources | CI-verified development bundle at l10n evidence revision `738a7c7328f24acc12c15be78bb11737220bbbae`, 59 generated artifacts, deterministic bundle SHA-256 `49ccf84b2afac15c604f74c45c6e7e72a1c12617eb5efdb3ada1d5164cd3c259`, unreleased |
