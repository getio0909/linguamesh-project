...
| Localization | `0.1.0` | Message schema `1.0.0`; resource contract `1`; 52 canonical messages including Linux-only status announcements | CI-verified development bundle, unreleased |
