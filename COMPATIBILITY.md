...
| Localization | `0.1.0` | Message schema `1.0.0`; resource contract `1`; 97 canonical messages including Linux-only status, partial-output, text-import, provider-profile, source-target, and onboarding-stage guidance | CI-verified development bundle, unreleased |
