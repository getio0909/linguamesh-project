...
Linux-first CSV document checkpoint: Core `d7e9b3857cf62f0a6dd24873091cb45dff8d4258` adds
bounded CSV delimiter/quote parsing, selected-column segmentation, safe provider decoding and
schema-9 persistence. Linux `d5fa1b0a3ce37d20eb6e7eae27086223e435214c` accepts `.csv` in the native
...
compositor/GPU rendering and packaging remain runtime boundaries. Native Open text file import accepts bounded UTF-8 TXT/Markdown/CSV/SRT/WebVTT content, and a single
