...
the default Tab chain remains an explicit Linux follow-up. Native `29661016843` (job `88123562296`),
Foundation `29661016844`, and Flatpak `29661016848` passed; provider-form Tab-chain repair,
