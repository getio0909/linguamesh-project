...
| Localization | `0.1.0` | Message schema `1.0.0`; resource contract `1`; 57 canonical messages including Linux-only status, partial-output, and text-import controls | CI-verified development bundle, unreleased |
