...
| Localization | `0.1.0` | Message schema `1.0.0`; resource contract `1`; 80 canonical messages including Linux-only status, partial-output, text-import, and provider-profile controls | CI-verified development bundle, unreleased |
