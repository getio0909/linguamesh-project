...
| Localization | `0.1.0` | Message schema `1.0.0`; resource contract `1`; 148 canonical messages including Linux-only status, partial-output, text-import, provider-profile, source-target, onboarding-stage, active-provider, notification, draft-note, fixed provider/file/worker errors, and reducer-state/category error guidance; paired PO/MO Linux resources | CI-verified development bundle at l10n evidence revision `0b906034784a1b5e81a879649abbfda001fa9e67`, 59 generated artifacts, deterministic bundle SHA-256 `d82a152aff0212b7dde55d9b9a67ceac7ed16245d6a0ca6de49564f7d1dafcc5`, unreleased |
