...
without source or translated content; private notification-service transport is verified, while
desktop-shell delivery and packaging remain runtime boundaries. Native Open text file import accepts bounded UTF-8 TXT/Markdown content, and a single
