...
| Localization | `0.1.0` | Message schema `1.0.0`; resource contract `1`; 117 canonical messages including Linux-only status, partial-output, text-import, provider-profile, source-target, onboarding-stage, active-provider, notification, draft-note, and fixed user-facing error guidance | CI-verified development bundle at l10n evidence revision `0ba26705e113230ae7d9e74db54039e1e82296ce`, unreleased |
