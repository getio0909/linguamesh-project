...
verified, while application-level GTK file-dialog callbacks and drag/drop portal gestures remain
open. It does not cover every database or storage failure. Real
