...
Linux-first text-PDF checkpoint: Core `7275c5ec195946ea20a2d65e5f42790b2d631ff2` adds bounded PDF
...
HTML alternative when target text cannot be safely encoded. Linux `a64e3751bdab9e6f21901f1d3bc8a7eb8004d0f0`
adds PDF chooser/MIME filtering, worker export fallback to `.html`, and updated documentation. Core
CI `29653737299`, Native SDK `29653737293`, Linux Native `29653900764`, Foundation `29653900780`,
and Flatpak `29653900782` are the current gates; OCR, pixel-identical reconstruction, image-only
page translation, remaining archive codecs, and other platform clients remain open.
