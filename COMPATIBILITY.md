...
| Localization | `0.1.0` | Message schema `1.0.0`; resource contract `1`; 148 canonical messages including Linux-only status, partial-output, text-import, provider-profile, source-target, onboarding-stage, active-provider, notification, draft-note, fixed provider/file/worker errors, and reducer-state/category error guidance | CI-verified development bundle at l10n evidence revision `08118b498646ebf56cbb072b937d95fceb34b75c`, deterministic bundle SHA-256 `08d252c8d3fbdd163e7a5f18eea06ac806029667b8c2ec1e836245d66c2b2595`, unreleased |
