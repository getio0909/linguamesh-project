...
while preserving timing and source content. Linux `829b502d98c570c72489720df49c3356dccc636a`
persists the warnings and renders cue-number-only guidance without exposing subtitle source text.
Core CI `29655212117`, Native SDK `29655212149`, Linux Native `29655260438`, Foundation
`29655260426`, and Flatpak `29655260429` passed; defaults are 42 Unicode characters per line and
