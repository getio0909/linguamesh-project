...
| Localization | `0.1.0` | Message schema `1.0.0`; resource contract `1`; 277 canonical messages including Linux-only status, partial-output, text-import, glossary CSV import/export, PDF fidelity and subtitle readability warnings, document-job actions/dialog/status/tooltip controls, Incognito privacy controls, history and translation-memory controls/status, translation-export, provider-profile, source-target, onboarding-stage, active-provider, notification, draft-note, locale selector language names, fixed provider/file/worker errors, reducer-state/category guidance, fixed worker/file/storage/provider-error guidance, construction-stage provider/default-control and request-level glossary copy, and Core/loopback startup plus profile-storage error copy; paired PO/MO Linux resources | CI-verified development bundle at l10n evidence revision `0ef4fb9b6878655e46e2b8ca5bbed9562f97b0f0`, 59 generated artifacts, deterministic bundle SHA-256 `e26da1a391369ed84c0f57f5fd5d440f50ed56dcbc8f069abd4d6d27db7dd9c1`, unreleased |
