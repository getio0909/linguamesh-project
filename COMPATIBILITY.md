...
| Localization | `0.1.0` | Message schema `1.0.0`; resource contract `1`; 193 canonical messages including Linux-only status, partial-output, text-import/export, provider-profile, source-target, onboarding-stage, active-provider, notification, draft-note, locale selector language names, fixed provider/file/worker errors, reducer-state/category guidance, fixed worker/file/storage/provider-error guidance, and construction-stage provider/default-control copy; paired PO/MO Linux resources | CI-verified development bundle at l10n evidence revision `057c1b8e859acfa4b4fd4eafbdc68ce01069f9a5`, 59 generated artifacts, deterministic bundle SHA-256 `deab18a136383deb586f81d08d433cf5cb494c627c92a09b1b7a28f7b918f5da`, unreleased |
