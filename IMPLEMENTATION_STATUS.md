...
| --- | --- | --- |
| Current Linux document-job metadata, OCR, localization-key audit, accessible progress, diagnostics, and pause-error localization | Validated locally and remotely | l10n `32bef261f5f0deb9f6a0426231e365d0bae72b62` contains 326 canonical messages and bundle SHA-256 `054d6749397cbbf652e099784f2c7d3`; Linux `1d96c9825b83cdc1cd6a2783b61fdd678b89e510` renders catalog-backed document rows and opt-in page-marked OCR text, statically audits 208 source keys, exposes native progress-bar semantics, localizes fixed diagnostics labels and values, and routes pause queue errors through catalog-backed rendering. Push Native `29672046465`, Foundation `29672046491`, and Flatpak `29672046488` passed; PR reruns `29672047299`, `29672047295`, and `29672047296` also passed. |
...
| Localization bundle | Validated locally and remotely | l10n revision `32bef261f5f0deb9f6a0426231e365d0bae72b62` contains 326 canonical messages, including opt-in image-only PDF OCR controls/errors, Linux diagnostics labels, 12 official locale packs, two pseudo-locales, 59 generated artifacts including paired Linux PO/MO resources, 26 passing tests, platform-format checks, and deterministic bundle ZIP SHA-256 `054d6749397cbbf652e099784f2c7d0e3650779a3c17c98e68d25560d286b2d3`. Non-English packs remain explicitly unreviewed drafts. |
...
| GitHub Actions | Passed | Core revision `81be0b8be9d7115b98eae3f134b4fd0f25411bbb` remains validated; l10n revision `32bef261f5f0deb9f6a0426231e365d0bae72b62` passed `29671276797`/`29671276786`; Linux head `1d96c9825b83cdc1cd6a2783b61fdd678b89e510` passed push Native `29672046465`, Foundation `29672046491`, and Flatpak `29672046488`, plus PR Native `29672047299`, Foundation `29672047295`, and Flatpak `29672047296`; the OCR fixture, 208-key localization audit, accessible progress assertions, localized diagnostics test, and pause-error localization passed in Native job `88152770602`; central coordination `29671939389` passed Linux job `88152482744` and PowerShell job `88152482759`. |
| Non-functional repository heads | Published | Core head `81be0b8be9d7115b98eae3f134b4fd0f25411bbb`, l10n head `32bef261f5f0deb9f6a0426231e365d0bae72b62`, and Linux behavioral head `1d96c9825b83cdc1cd6a2783b61fdd678b89e510` are published; docs-only Linux evidence head `86c508c4b6fc6f41693d5b043bf61d1d5aa7ea23` is also published. Current-head Linux Native/Flatpak/Foundation gates passed. The release manifest remains unreleased with no artifacts. |
