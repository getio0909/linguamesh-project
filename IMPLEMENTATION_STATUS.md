...
| GitHub Actions | Passed | Core run `29572377637` (Rust job `87858924329`) and Native SDK run `29572377631` (Linux job `87858924315`) passed for the functional Core source. Linux Wayland-gate run `29582513061` (job `87891382469`) and evidence-head run `29582714651` (job `87892044520`) passed both display gates and the all-feature build. Central revision `f7df9ef3675b218ebc94df74ba26f2256db6fa34` passed integration run `29581079831`, Linux job `87886675010`, and PowerShell job `87886675039`; prior repository and localization evidence remains recorded in component status files. |
