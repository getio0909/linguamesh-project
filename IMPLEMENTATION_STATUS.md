...
| GitHub Actions | Passed | Core revision `81be0b8be9d7115b98eae3f134b4fd0f25411bbb` remains validated; l10n revision `3f3c1a1154b66d25f2936a02b8a08d2a8fc8a878` passed `29669015989`/`29669016025`; Linux head `ca040585db0baaced263d438714110ddfdb315b0` passed push Native `29670131311`, Foundation `29670131313`, and Flatpak `29670131281`, plus PR Native `29670131967`, Foundation `29670131969`, and Flatpak `29670131964`; code-head runs `29669977294`/`29669977297`/`29669977295` and earlier PR reruns `29669978352`/`29669978350`/`29669978371` also passed; the OCR fixture, localization-key audit, and accessible progress assertions passed in Native job `88147494109`; central coordination `29669694443` passed Linux job `88146359206` and PowerShell job `88146359202`. |
