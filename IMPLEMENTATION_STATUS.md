...
inspection, exact per-entry deletion, and deterministic escaped UTF-8 TSV export; translation memory
...
| GitHub Actions | Passed | l10n revision `40f3914e1b28fddd8f38d287fa121010f5192f1c` passed Localization run `29639069395` and Foundation run `29639069371`; Core functional revision `fb00f3dd6b62a8a3a47350acc85831e60e266929` passed CI run `29638960182` and Native SDK run `29638960230`. Linux revision `7173d4a4217d6211c7dc92c368d9f033874198f5` passed Native run `29639139698` (job `88066556152`), Foundation run `29639139712`, and Flatpak run `29639139725` (job `88066556256`). Central documentation revision `08250c870b42b6df249c30a0379a5db505ef23c2` passed coordination run `29638614216` (Linux job `88065175722`, PowerShell job `88065175707`). |
| Non-functional repository heads | Passed | Core head `fb00f3dd6b62a8a3a47350acc85831e60e266929` is the functional glossary-CSV, long-text-chunking, Incognito-policy, and bounded-history pin and passed CI plus the full Native SDK matrix. Linux functional revision `7173d4a4217d6211c7dc92c368d9f033874198f5` passed Native, Foundation, and Flatpak gates; documentation head `1115d75` records the evidence. The release manifest intentionally pins functional revisions and lists no release artifact. |
