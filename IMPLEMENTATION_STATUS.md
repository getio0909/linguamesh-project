...
- Linux `07af541f5c8561da4f917406c6782155a2a5efb6` persists warnings on imported/restored jobs and
  ...
  locked checks and strict Clippy passed; Native `29655816018`, Foundation `29655816025`, and
  Flatpak `29655816020` passed. The host-only GTK targeted test remained unavailable because the
...
| Localization bundle | Validated locally and remotely | l10n evidence revision `6bcd237170d1fdfb0a6beb88ee97d1855c478611` contains 264 canonical messages, including Linux translation-memory controls/status and subtitle readability warnings, 12 official locale packs, two pseudo-locales, 59 generated artifacts including paired Linux PO/MO resources, 26 passing tests, platform-format checks, and deterministic bundle ZIP SHA-256 `ee7bf5308a7cd652cad37e8d5e96973c520123dbbf964ddee58bf02bb24cbf7e`. Non-English packs remain explicitly unreviewed drafts. |
| Native Linux alpha.2 slice | Validated locally and remotely | Functional revision `07af541f5c8561da4f917406c6782155a2a5efb6` negotiates `bounded_text_document_v1`, converts bounded TXT/Markdown/CSV/JSON/HTML/SRT/WebVTT/DOCX/PPTX/XLSX/EPUB/PDF imports into Core jobs, preserves subtitle cue IDs/headers/timestamps and surfaces configurable cue-level line-length/reading-speed warnings without source content, CSV delimiters/quotes/variable-width rows/selected-column boundaries, JSON structure/path selection/escaping, HTML tags/attributes/links/scripts/styles/text nodes, OOXML/EPUB non-text resources and supported text nodes, PDF page association/coordinates and structured HTML fallback, sequentially translates pending prose segments with persisted progress, lists persisted jobs in the GTK queue, supports selection plus pause/resume/retry/cancel/export, and restores schema-14 snapshots without paths or credentials while retaining secure-provider, glossary, history, policy, and translation-memory behavior. Local 61/99-test suites, strict Clippy, Rust checks, and diff checks passed; Native `29655816018`, Foundation `29655816025`, and Flatpak `29655816020` passed. |
| Linux Flatpak packaging scaffold | Static validation passed; remote passed | Linux packaging revision `07af541f5c8561da4f917406c6782155a2a5efb6` publishes the pinned GNOME 49 manifest, immutable Core/Linux source pins including DOCX/PPTX/XLSX/EPUB/PDF warning UI, subtitle cue warning UI, and the queue UI, generated Cargo archive hashes for the current lockfile, desktop entry, AppStream metadata, icon, and constrained runtime permissions. `bash tools/validate-flatpak-metadata.sh` passed locally; `Flatpak Linux` run `29655816020` passed. Physical compositor/GPU rendering, signing, and distributable release remain unverified. |
| GitHub Actions | Passed | Core revision `81be0b8be9d7115b98eae3f134b4fd0f25411bbb` passed CI `29655212117` and Native SDK `29655212149`; Linux revision `07af541f5c8561da4f917406c6782155a2a5efb6` passed Native `29655816018`, Foundation `29655816025`, and Flatpak `29655816020`; l10n revision `6bcd237170d1fdfb0a6beb88ee97d1855c478611` passed Localization `29655762044` and Foundation `29655762054`. |
| Non-functional repository heads | Published | Core head `81be0b8be9d7115b98eae3f134b4fd0f25411bbb`, l10n head `6bcd237170d1fdfb0a6beb88ee97d1855c478611`, and Linux head `07af541f5c8561da4f917406c6782155a2a5efb6` are published functional pins and passed their remote gates. The release manifest remains unreleased with no artifacts. |
