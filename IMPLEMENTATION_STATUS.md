...
- Linux `4b8ffdedff22b31321ff8ab8395ccb53f784ccc8` records that Core revision in Native CI and Flatpak
  ...
  and diff checks.
- Linux push Native `29685292569` (job `88188414822`), Foundation `29685292538` (job `88188414712`),
  and Flatpak `29685292531` (job `88188414614`) passed. PR Native `29685293703` (job `88188417598`),
  Foundation `29685293644` (job `88188417433`), and Flatpak `29685293646` (job `88188417590`) passed.
...
| Non-functional repository heads | Published | Core head `63fc0ca62e2b1d9bd168a60e6c9051ac338f6486`, l10n head `85b9d45569ce840c17dc0acc7d7366d6810be48e`, and Linux behavioral/evidence head `4b8ffdedff22b31321ff8ab8395ccb53f784ccc8` are published. Current-head Linux Native/Flatpak/Foundation push and PR gates passed. The release manifest remains unreleased with no artifacts. |
