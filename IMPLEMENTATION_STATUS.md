...
| GitHub Actions | Passed | l10n revision `6a1f0e914e56788c34970bd7b18c8f963026ff73` passed Localization run `29630392940` (job `88042717313`) and Foundation run `29630392962` (job `88042717303`). Linux revision `e79df4442a104b2d4e89f8ac81d7442773636771` passed Native run `29630434240` (job `88042823692`), Foundation run `29630434252` (job `88042823739`), and Flatpak run `29630434241` (job `88042823704`) with export-aware GTK, PO/MO, and GNOME 49 sandbox gates. Central integration run `29630646183` passed Linux job `88043385432` and PowerShell job `88043385414`. |
