...
| --- | --- | --- |
| Current Linux document-job metadata, OCR, localization-key audit, accessible progress, and diagnostics | Validated locally and remotely | l10n `32bef261f5f0deb9f6a0426231e365d0bae72b62` contains 326 canonical messages and bundle SHA-256 `054d6749397cbbf652e099784f2c7d0e3650779a3c17c98e68d25560d286b2d3`; Linux `355481d937b3722e509dbd05cc1575c4e71be143` renders catalog-backed document rows and opt-in page-marked OCR text, statically audits 208 source keys, exposes native progress-bar semantics, and localizes all fixed diagnostics labels and values. Push Native `29671444706`, Foundation `29671444731`, and Flatpak `29671444733` passed; PR reruns `29671445475`, `29671445499`, and `29671445495` also passed. |
...
| GitHub Actions | Passed | Core revision `81be0b8be9d7115b98eae3f134b4fd0f25411bbb` remains validated; l10n revision `32bef261f5f0deb9f6a0426231e365d0bae72b62` passed `29671276797`/`29671276786`; Linux head `355481d937b3722e509dbd05cc1575c4e71be143` passed push Native `29671444706`, Foundation `29671444731`, and Flatpak `29671444733`, plus PR Native `29671445475`, Foundation `29671445499`, and Flatpak `29671445495`; the OCR fixture, 208-key localization audit, accessible progress assertions, and localized diagnostics test passed in Native job `88151076586`; central coordination `29670873194` passed Linux job `88149460223` and PowerShell job `88149460222`. |
| Non-functional repository heads | Published | Core head `81be0b8be9d7115b98eae3f134b4fd0f25411bbb`, l10n head `32bef261f5f0deb9f6a0426231e365d0bae72b62`, and Linux head `355481d937b3722e509dbd05cc1575c4e71be143` are published; current-head Linux Native/Flatpak/Foundation gates passed. The release manifest remains unreleased with no artifacts. |
