...
| GitHub Actions | Passed | Core run `29572377637` (Rust job `87858924329`) and Native SDK run `29572377631` (Linux job `87858924315`) passed for the functional Core source. Linux foundation run `29580444697` and Native Linux run `29580444723` (job `87884607879`) passed for the functional onboarding client source. Central revision `f2c3a5532fed81ebe056c0d6de33d81b404b15cf` passed integration run `29578424525`, Linux job `87878121729`, and PowerShell job `87878121792`; prior repository and localization evidence remains recorded in component status files. |
