...
completions skip history writes. History inspection/export, per-entry deletion, and translation
memory remain later slices.
...
| GitHub Actions | Passed | l10n revision `4678fc3810b1e21e5ab8c1095e552930b8649687` passed Localization run `29636630359` and Foundation run `29636630348`; Core functional revision `8cd65c5846a677e70c4828e4b4a5192319d775d5` passed CI run `29636624648` and Native SDK run `29636624656`. Linux revision `b968cc21978dd5bea1b4bc6d1c8828bb8ecdc489` passed Native run `29637270603` (job `88061682829`), Foundation run `29637270599`, and Flatpak run `29637270601` (job `88061682853`). Central documentation revision `1eeabd86daab8c3a3b34374fca2786ee9788794f` passed coordination run `29637067024`. |
| Non-functional repository heads | Passed | Core head `8cd65c5846a677e70c4828e4b4a5192319d775d5` is the functional glossary-CSV, long-text-chunking, Incognito-policy, and bounded-history pin and passed CI plus the full Native SDK matrix. Linux functional revision `b968cc21978dd5bea1b4bc6d1c8828bb8ecdc489` passed Native, Foundation, and Flatpak gates; documentation head `b01b4b9` records the evidence. The release manifest intentionally pins functional revisions and lists no release artifact. |
