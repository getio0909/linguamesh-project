...
| GitHub Actions | Passed | Linux functional run `29628307915` and foundation run `29628307945` passed the exact fault test, persistent Secret Service lifecycle and secure-onboarding fixtures, no-credential loopback regression, GTK assertions, both display gates, bounded import path, reducer-state localization, and the all-feature build; Flatpak run `29628307886` passed the GNOME 49 SDK build and smoke gate. Central integration commit `b4d6afe` passed coordination run `29628561782` with Linux job `88037742108` and PowerShell job `88037742148`. |
