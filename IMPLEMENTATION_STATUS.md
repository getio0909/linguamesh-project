...
- Linux `4101dffa9d300c1919fbb01f85e634521ccc54b3` records that Core revision in Native CI and Flatpak
  ...
  and diff checks.
- Linux push Native `29683990603` (job `88185022942`), Foundation `29683990650` (job `88185023021`),
  and Flatpak `29683990621` (job `88185022881`) passed. PR Native `29683991818` (job `88185026274`),
  Foundation `29683991925` (job `88185026336`), and Flatpak `29683991824` (job `88185026256`) passed.
...
| Non-functional repository heads | Published | Core head `63fc0ca62e2b1d9bd168a60e6c9051ac338f6486`, l10n head `85b9d45569ce840c17dc0acc7d7366d6810be48e`, and Linux behavioral/evidence head `4101dffa9d300c1919fbb01f85e634521ccc54b3` are published. Current-head Linux Native/Flatpak/Foundation push and PR gates passed. The release manifest remains unreleased with no artifacts. |
