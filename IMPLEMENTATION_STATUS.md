...
| GitHub Actions | Passed | Core revision `81be0b8be9d7115b98eae3f134b4fd0f25411bbb` passed CI `29655212117` and Native SDK `29655212149`; l10n revision `273be8a4e9c3b1084f393ce0086cdf2c42fcd4e9` passed Localization `29658713355` and Foundation `29658713372`; Linux default branch head `014a79a` passed Native `29665725241`, Foundation `29665725238`, and Flatpak `29665725434`; the AT-SPI fixture passed in Native job `88134735908`; central coordination `29665576232` passed the previous central documentation head. |
| Non-functional repository heads | Published | Core head `81be0b8be9d7115b98eae3f134b4fd0f25411bbb`, l10n head `273be8a4e9c3b1084f393ce0086cdf2c42fcd4e9`, and Linux head `014a79a19cb72b4eceba3d7c0c592b7655e1cdd0` are published; current-head Linux Native/Flatpak/Foundation gates passed. The release manifest remains unreleased with no artifacts. |
