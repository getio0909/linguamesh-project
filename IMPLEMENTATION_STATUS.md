...
| GitHub Actions | Passed | Core revision `81be0b8be9d7115b98eae3f134b4fd0f25411bbb` remains validated; l10n revision `cacc1577bc1a19a94c11faeffa7a63016d54d64e` passed `29668388983`/`29668388992`; Linux default branch head `d18e8dfa3dd98d56dbe0d5d1eabc536d38b96f1c` passed Native `29668688201`, Foundation `29668688202`, and Flatpak `29668688223`; the OCR fixture passed in Native job `88143670012`. |
