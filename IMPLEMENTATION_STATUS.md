...
| --- | --- | --- |
| Current Linux document-job metadata, OCR, localization-key audit, accessible progress, and diagnostics | Validated locally and remotely | l10n `3f3c1a1154b66d25f2936a02b8a08d2a8fc8a878` contains 306 canonical messages and bundle SHA-256 `6fc6839fce3a449eaf37d2efb9a52fa0ede1eab3a39fecdaff68682a79d8a4f8`; Linux `3a135bf86d3627dafb48d53164e4568a9c9e5c03` renders catalog-backed document rows and opt-in page-marked OCR text, statically audits 188 source keys, exposes native progress-bar semantics, and localizes the diagnostics summary. Push Native `29670658430`, Foundation `29670658434`, and Flatpak `29670658437` passed; PR reruns `29670659495`, `29670659502`, and `29670659509` also passed. |
...
| GitHub Actions | Passed | Core revision `81be0b8be9d7115b98eae3f134b4fd0f25411bbb` remains validated; l10n revision `3f3c1a1154b66d25f2936a02b8a08d2a8fc8a878` passed `29669015989`/`29669016025`; Linux head `3a135bf86d3627dafb48d53164e4568a9c9e5c03` passed push Native `29670658430`, Foundation `29670658434`, and Flatpak `29670658437`, plus PR Native `29670659495`, Foundation `29670659502`, and Flatpak `29670659509`; the OCR fixture, 188-key localization audit, accessible progress assertions, and localized diagnostics test passed in Native job `88148892557`; central coordination `29670311114` passed Linux job `88147963403` and PowerShell job `88147963364`. |
| Non-functional repository heads | Published | Core head `81be0b8be9d7115b98eae3f134b4fd0f25411bbb`, l10n head `3f3c1a1154b66d25f2936a02b8a08d2a8fc8a878`, and Linux head `3a135bf86d3627dafb48d53164e4568a9c9e5c03` are published; current-head Linux Native/Flatpak/Foundation gates passed. The release manifest remains unreleased with no artifacts. |
