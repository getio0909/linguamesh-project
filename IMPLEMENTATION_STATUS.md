...
| GitHub Actions | Passed | Core revision `81be0b8be9d7115b98eae3f134b4fd0f25411bbb` passed CI `29655212117` and Native SDK `29655212149`; l10n revision `273be8a4e9c3b1084f393ce0086cdf2c42fcd4e9` passed Localization `29658713355` and Foundation `29658713372`; Linux default branch head `1b68cef` passed Native `29664934283`, Foundation `29664934298`, and Flatpak `29664934279`; the AT-SPI fixture passed in Native job `88133657483`; central coordination `29664611878` passed Linux job `88132835095` and PowerShell job `88132917951` for the previous documentation head. |
| Non-functional repository heads | Published | Core head `81be0b8be9d7115b98eae3f134b4fd0f25411bbb`, l10n head `273be8a4e9c3b1084f393ce0086cdf2c42fcd4e9`, and Linux head `1b68cef85d89324baba20689ce246486ab28c49b` are published; current-head Linux Native/Flatpak/Foundation gates passed. The release manifest remains unreleased with no artifacts. |
