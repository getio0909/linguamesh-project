...
- Linux `b982b75d73995338512b375d2ae3b1c139a5d479` records that Core revision in Native CI and Flatpak
  ...
  and diff checks.
- Linux push Native `29683317201` (job `88183229014`), Foundation `29683317159` (job `88183228746`),
  and Flatpak `29683317150` (job `88183228765`) passed. PR Native `29683318279` (job `88183232304`),
  Foundation `29683318299` (job `88183232365`), and Flatpak `29683318280` (job `88183232313`) passed.
...
| Non-functional repository heads | Published | Core head `63fc0ca62e2b1d9bd168a60e6c9051ac338f6486`, l10n head `85b9d45569ce840c17dc0acc7d7366d6810be48e`, and Linux behavioral/evidence head `b982b75d73995338512b375d2ae3b1c139a5d479` are published. Current-head Linux Native/Flatpak/Foundation push and PR gates passed. The release manifest remains unreleased with no artifacts. |
