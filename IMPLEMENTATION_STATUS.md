...
| GitHub Actions | Passed | Core run `29572377637` (Rust job `87858924329`) and Native SDK run `29572377631` (Linux job `87858924315`) passed for the functional Core source. Linux foundation run `29577918346` and Native Linux run `29577918335` (job `87876528763`) passed for the functional multi-profile client source. Central integration run `29574894213` passed Linux job `87867019678` and PowerShell job `87867019699`; prior repository and localization evidence remains recorded in component status files. |
