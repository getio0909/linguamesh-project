...
- l10n `cacc1577bc1a19a94c11faeffa7a63016d54d64e` adds ten Linux-only OCR toggle/progress/error
...
| --- | --- | --- |
| Current Linux document-job metadata and OCR slice | Validated locally and remotely | l10n `cacc1577bc1a19a94c11faeffa7a63016d54d64e` contains 306 canonical messages and bundle SHA-256 `6fc6839fce3a449eaf37d2efb9a52fa0ede1eab3a39fecdaff68682a79d8a4f8`; Linux `d18e8dfa3dd98d56dbe0d5d1eabc536d38b96f1c` renders catalog-backed document rows and opt-in page-marked OCR text. Native `29668688201`, Foundation `29668688202`, and Flatpak `29668688223` passed. |
...
| Localization bundle | Validated locally and remotely | l10n revision `cacc1577bc1a19a94c11faeffa7a63016d54d64e` contains 306 canonical messages, including opt-in image-only PDF OCR controls/errors, 12 official locale packs, two pseudo-locales, 59 generated artifacts including paired Linux PO/MO resources, 26 passing tests, platform-format checks, and deterministic bundle ZIP SHA-256 `6fc6839fce3a449eaf37d2efb9a52fa0ede1eab3a39fecdaff68682a79d8a4f8`. Non-English packs remain explicitly unreviewed drafts. |
...
| GitHub Actions | Passed | Core revision `81be0b8be9d7115b98eae3f134b4fd0f25411bbb` remains validated; l10n revision `cacc1577bc1a19a94c11faeffa7a63016d54d64e` passed `29668388983`/`29668388992`; Linux default branch head `d18e8dfa3dd98d56dbe0d5d1eabc536d38b96f1c` passed Native `29668688201`, Foundation `29668688202`, and Flatpak `29668688223`; the OCR fixture passed in Native job `88143670012`; central coordination `29668960758` passed Linux and PowerShell validation. |
| Non-functional repository heads | Published | Core head `81be0b8be9d7115b98eae3f134b4fd0f25411bbb`, l10n head `cacc1577bc1a19a94c11faeffa7a63016d54d64e`, and Linux head `d18e8dfa3dd98d56dbe0d5d1eabc536d38b96f1c` are published; current-head Linux Native/Flatpak/Foundation gates passed. The release manifest remains unreleased with no artifacts. |
