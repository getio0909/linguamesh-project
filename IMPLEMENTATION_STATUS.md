...
| GitHub Actions | Passed | Linux functional run `29604269568` (job `87963611054`) and foundation run `29604269516` passed the exact fault test, persistent Secret Service lifecycle and secure-onboarding fixtures, no-credential loopback regression, GTK assertions, both display gates, bounded import path, and the all-feature build. Linux evidence head `20433c9` passed Native Linux run `29613020196`, Foundation run `29613020145`, and Flatpak run `29613020144`; native job `87990400327` verified the real `dunst` notification daemon delivery fixture, while the same head retained the real document-portal lease fixture. Central integration commit `3ff3d11` recorded the document-portal evidence and passed coordination run `29612315893`; this daemon-delivery evidence is pending the next central sync. |
