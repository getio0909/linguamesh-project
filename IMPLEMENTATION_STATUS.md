...
| GitHub Actions | Passed | Core run `29572377637` (Rust job `87858924329`) and Native SDK run `29572377631` (Linux job `87858924315`) passed for the functional Core source. Linux accessibility run `29589043315` (job `87913221576`) and evidence-head run `29589332282` (job `87914189125`) passed the exact fault test, accessibility assertions, both display gates, and the all-feature build. Central integration revision `409e25716c36f94777fea5a2a6e9b1e9b13ce076` passed coordination run `29589860768`, Linux job `87915946902`, and PowerShell job `87915946857`; prior repository and localization evidence remains recorded in component status files. |
