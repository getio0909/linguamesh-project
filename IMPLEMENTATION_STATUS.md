...
- Linux `191a11d9bec3623c5403403b9ab489c7642ca62f` records that Core revision in Native CI and Flatpak
  ...
  and diff checks.
- Linux push Native `29683647497` (job `88184121732`), Foundation `29683647505` (job `88184121734`),
  and Flatpak `29683647507` (job `88184121686`) passed. PR Native `29683648413` (job `88184124434`),
  Foundation `29683648406` (job `88184124411`), and Flatpak `29683648422` (job `88184124490`) passed.
...
| Non-functional repository heads | Published | Core head `63fc0ca62e2b1d9bd168a60e6c9051ac338f6486`, l10n head `85b9d45569ce840c17dc0acc7d7366d6810be48e`, and Linux behavioral/evidence head `191a11d9bec3623c5403403b9ab489c7642ca62f` are published. Current-head Linux Native/Flatpak/Foundation push and PR gates passed. The release manifest remains unreleased with no artifacts. |
