...
- Linux `829b502d98c570c72489720df49c3356dccc636a` persists warnings on imported/restored jobs and
  ...
  locked checks and strict Clippy passed; Native `29655260438`, Foundation `29655260426`, and
  Flatpak `29655260429` passed. The host-only GTK targeted test remained unavailable because the
